...
![Diagramme de cas d'utilisation](cas_usage.png){#fig-cas-usage width="62%"}
...
Le diagramme ci-dessus offre une vue d'ensemble organisée par paquetage fonctionnel. Le détail des cas d'utilisation qui composent chacun d'eux est précisé ci-dessous.

**F1 – Gérer son compte**

- S'authentifier
- Créer un compte
- Mettre à jour son profil (mot de passe, email, bio)

**F2 – Rechercher et consulter**

- Rechercher un livre
- Consulter la fiche d'un livre
- Consulter son propre profil (bio, nombre d'abonnés, d'abonnements, de livres, de critiques, de likes/dislikes)

**F3 – Gérer sa bibliothèque**
...
- Noter un livre (de 0 à 5, si lu ou abandonné)

**F4 – Gérer les critiques**

- Rédiger une critique (si le livre est lu ou abandonné)
- Consulter les critiques d'un livre

*Note et critique relèvent volontairement de deux cas d'utilisation distincts : un lecteur peut vouloir noter un livre sans rédiger de critique, ou l'inverse.*

**F5 – Obtenir des recommandations**

- Visualiser des recommandations personnalisées

*À ce stade, la logique de recommandation n'est pas totalement arrêtée. Le principe retenu est d'afficher plusieurs sections de recommandations générées automatiquement (par exemple : « de vos auteurs favoris », « les populaires d'Ex-Libris »), combinant différents critères — dont le réseau d'abonnements de l'utilisateur (F5B)*

**FO1 – Gérer sa communauté** *(optionnel)*
...
**FOX – Réagir aux critiques** *(optionnel)*
