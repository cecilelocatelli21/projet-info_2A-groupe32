...
![Structure des données Open Library : oeuvre](work.png){#fig-openlibrary-work width="60%"}

Notre choix principal est de nous appuyer, en base, sur une référence unique par œuvre (Work), qui sert d'ancrage à l'ensemble des lectures, notes et critiques associées. Notre Business Object garde néanmoins, via ses attributs, la possibilité de porter des informations d'édition (langue, format...), afin de conserver cette richesse de choix pour l'utilisateur. Ce fonctionnement est détaillé plus loin, lors de la conception de la maquette.
...
Un diagramme général correspond à l'arrivée sur la page d'acceuil du site et le choix des principales fonctionnalités. Les grandes fonctionnalités sont détaillées dans les diagrammes suivants.
...
![Diagramme d'activité : gestion du profil personnel](diagramme_activite_profil_perso.png){#fig-activite_profil_perso width="40%"}

![Diagramme d'activité : consultation d'un livre](diagramme_activite_livre.png){#fig-activite_livre width="40%"}

![Diagramme d'activité : consultation du profil d'un utilisateur](diagramme_activite_utilisateur.png){#fig-activite_login width="40%"}
...
![Diagramme de séquence : supprimer une fiche de lecture](Diagramme_Sequence_Suppression-fiche-lecture_page-0001.jpg){#fig-seq_supprime width="90%"}
