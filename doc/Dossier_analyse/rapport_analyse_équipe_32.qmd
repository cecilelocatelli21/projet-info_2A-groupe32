...
Ce rapport nous a permis de découvrir le codage en couches avec les fonctionnalités nécessaires pour coder l'application demandée (controller, Dao, Service) et nous a obligé à réfléchir sur les moyens pour l'optimiser (nombre de requêtes à OpenLibrary, stockage des donnée intéressantes).
